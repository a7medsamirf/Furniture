...
<top-nav />
   ...
   <!---------- End App Bar ---------->
    ...
    <v-divider class="white--text"></v-divider>
       ...
       <v-list-item class="pa-3 remove-cart">
       ...
       <v-btn class="close-icon" icon @click="rightDrawer = !rightDrawer"><v-icon>mdi-close</v-icon></v-btn>
          ...
          <template v-slot:append>
            ...
            <div class="total-cart">
						<div class="title-total">Subtotal: </div>
            <v-spacer></v-spacer>
						<div class="total-price"><span class="amount">740.00<span class="woocommerce-Price-currencySymbol">$</span></span></div>
					</div>
